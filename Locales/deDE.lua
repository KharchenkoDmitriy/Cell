...
L["Color Duration Text Unavailable Tip"] = "Dies ist leider seit Patch 12.0.0 wegen der Blizzard-API nicht mehr möglich."
...
L["nonPlayerAurasTip"] = "Blendet Lust-Nachwirkungen wie Erschöpfung, Sättigung, Vorahnung und Zeitverzerrung aus, sowie Teufelsrüstung. Encounter-Debuffs bleiben sichtbar."
L["debuffTooltipMouseoverTip"] = "Das Bewegen der Maus über ein Icon hier blockiert eigene @mouseover-Makros/Zauber an dieser Stelle. Lass den Haken weg, um das komplett zu vermeiden."
L["Language"] = "Sprache"
L["Client Language"] = "Client-Sprache"
L["Color by Health"] = "Nach Gesundheit einfärben"
L["colorByHealthTip"] = "Färbt die Farbe dieses Segments je nach Gesundheit von Rot (niedrig) über Gelb bis zur normalen Farbe ein."
L["Fade at Full Health"] = "Bei voller Gesundheit ausblenden"
L["healthFadeTip"] = "Dimmt das Frame eines Spielers (mit dem Wert von 'Out of Range Alpha'), sobald dessen Gesundheit über den unten eingestellten Schwellenwert steigt — volle Spieler treten optisch zurück, verletzte fallen auf."
L["Health Fade Threshold"] = "Schwellenwert für Gesundheits-Ausblendung"
L["2 Decimals"] = "2 Nachkommastellen"
L["Hide if 0"] = "Bei 0 ausblenden"
L["Hide the deficit text once a unit is topped off"] = "Blendet den Fehlbetrag-Text aus, sobald ein Gruppenmitglied volle Gesundheit hat"
L["raidStyleSwitchChatMsg"] = "Traditionelle Party-Frames verursachen bekannte Blizzard-Fehler (Taint). Cell hat automatisch auf 'Gruppen wie Schlachtzüge anzeigen' (Raid-Style Party Frames) umgestellt. Ein UI-Reload ist nötig, damit die Änderung wirkt."
L["raidStyleSwitchPopupText"] = "Traditionelle Party-Frames verursachen bekannte Blizzard-Fehler.\n\nCell hat automatisch auf 'Gruppen wie Schlachtzüge anzeigen' (Raid-Style Party Frames) umgestellt, um das zu vermeiden.\n\nEin UI-Reload ist nötig, damit die Änderung wirkt.\n "
L["Dispels"] = "Dispels"
...
L["Boss Debuffs"] = "Highlight Debuffs"
L["Raid debuffs"] = "Raid debuffs"
L["bossDebuffsApiWarning"] = "Highlight Debuffs zeigt schädliche Auren, die auf mindestens einen der unten angehakten Filter passen. Alles andere bleibt beim normalen Debuffs-Indikator. Eigene Spell-Listen steuern das unter Retail (12.1+) nicht mehr."
L["bossDebuffsTabNotice"] = "Eigene Raid-Debuff-Listen funktionieren unter Retail (12.1+) nicht mehr\n\nBlizzard versteckt viele Spell-IDs von Kampf-Auren auf Party- und Raidframes. Addons können deshalb nicht mehr zuverlässig nach deiner eigenen An-/Abhaken-Liste filtern.\n\nWas sich geändert hat:\n• Der alte Indikator „Raid Debuffs“ heißt jetzt „Highlight Debuffs“.\n• Er zeigt schädliche Auren nach den unten angehakten Filterklassen (von Blizzard bereitgestellte Flags, z.B. isBossAura).\n• Alles andere bleibt beim normalen Debuffs-Indikator.\n\nDie Spell-Liste, Häkchen und Reihenfolge in diesem Tab haben auf Retail-Frames keine Wirkung mehr. Classic und MoP bleiben unverändert."
L["highlightDebuffFilters"] = "Filter"
L["highlightDebuffFilters_nonplayer"] = "Nicht-Spieler Auren"
L["highlightDebuffFilters_priority"] = "Wichtig"
L["highlightDebuffFilters_cc"] = "Kontrolleffekte"
L["highlightDebuffFilters_bossaura"] = "Boss Debuffs"
L["highlightDebuffFilters_roleaura"] = "Role Debuffs"
L["highlightDebuffFilters_raid"] = "Schlachtzug"
L["highlightDebuffFilters_raidcombat"] = "Raid In Combat"
L["highlightDebuffFilters_dispellable"] = "Dispellable By You"
L["highlightDebuffFilters_dispeltyped"] = "Bannbare Effekte"
L["highlightDebuffFiltersTip"] = "Angehakte Filter kombinieren sich und schließen sich aus: ein Treffer wird nur vom ersten passenden Filter gezeigt (oben nach unten), nie doppelt. Nichts angehakt = nichts angezeigt."
L["highlightDebuffFiltersTip_nonplayer"] = "Zeigt Debuffs, die NICHT von dir oder deinem Pet gewirkt wurden."
L["highlightDebuffFiltersTip_priority"] = "Zeigt Debuffs, die Blizzard als wichtig für Raidframes markiert (isPriorityAura)."
L["highlightDebuffFiltersTip_cc"] = "Zeigt Debuffs, die Massenkontrolle sind (Betäubung, Furcht, Wurzeln usw.)."
L["highlightDebuffFiltersTip_bossaura"] = "Zeigt Debuffs, die Blizzard als Boss-Auren markiert (Dungeon-/Raidbosse)."
L["highlightDebuffFiltersTip_roleaura"] = "Zeigt Debuffs, die Blizzard als rollenrelevant markiert (z.B. Tank-Debuffs)."
L["highlightDebuffFiltersTip_raid"] = "Zeigt Debuffs, die Blizzard als schlachtzugsrelevant markiert."
L["highlightDebuffFiltersTip_raidcombat"] = "Zeigt schlachtzugsrelevante Debuffs, während du im Kampf bist."
L["highlightDebuffFiltersTip_dispellable"] = "Zeigt Debuffs, die DU gerade selbst entfernen/reinigen kannst."
L["highlightDebuffFiltersTip_dispeltyped"] = "Zeigt jeden Debuff mit einem Dispel-Typ (Magie/Fluch/Krankheit/Gift/Blutung), unabhängig davon ob du ihn entfernen kannst."
