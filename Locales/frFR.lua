...
L["raidStyleSwitchChatMsg"] = "Les cadres de groupe traditionnels causent des erreurs Blizzard connues (taint). Cell est passé automatiquement aux cadres de groupe de style raid pour éviter cela. Un rechargement de l'interface est nécessaire pour que le changement prenne effet."
L["raidStyleSwitchPopupText"] = "Les cadres de groupe traditionnels causent des erreurs Blizzard connues.\n\nCell est passé automatiquement aux cadres de groupe de style raid pour éviter cela.\n\nUn rechargement de l'interface est nécessaire pour que le changement prenne effet.\n "
L["bossDebuffsTabNotice"] = "Les listes personnalisées d'Affaiblissements de Raid ne fonctionnent plus sur Retail (12.1+)\n\nBlizzard masque de nombreux ID de sorts des auras de combat sur les cadres de groupe et de raid, les addons ne peuvent donc plus filtrer de manière fiable selon votre propre liste de cases à cocher.\n\nCe qui a changé :\n• L'ancien indicateur « Affaiblissements de Raid » s'appelle désormais « Highlight Debuffs ».\n• Il affiche les auras nuisibles correspondant aux classes de filtre cochées ci-dessous (indicateurs fournis par Blizzard, ex. isBossAura).\n• Tout le reste reste sur l'indicateur Affaiblissements normal.\n\nLa liste de sorts, les cases à cocher et l'ordre de cet onglet n'ont plus aucun effet sur les cadres Retail. Classic et MoP restent inchangés."
L["nonPlayerAurasTip"] = "Masque les effets rémanents de Bénédiction comme Épuisement, Rassasié, Clémence et Distorsion temporelle, ainsi que l'Armure démoniaque. Les affaiblissements de rencontre restent visibles."
L["debuffTooltipMouseoverTip"] = "Survoler une icône ici bloquera vos propres macros/sorts @mouseover à cet endroit. Laissez cette case décochée pour éviter cela complètement."
L["keepInHealersTip"] = "Si activé, ce bonus reste aussi visible dans l'indicateur Soigneurs.|Si désactivé, il n'apparaît qu'ici et est retiré des Soigneurs."
L["glowDisabledApiWarning"] = "Malheureusement, la lueur ne peut pas être implémentée pour le moment en raison de changements d'API. J'ai désactivé cet indicateur pour l'instant, en attendant une solution."
L["crowdControlsApiWarning"] = "Cell ne peut plus utiliser une liste de CC personnalisée. Blizzard décide quels affaiblissements sont du contrôle de foule, et cet indicateur les affiche automatiquement."
L["bossDebuffsApiWarning"] = "Highlight Debuffs affiche les auras nuisibles correspondant à l'un des filtres cochés ci-dessous. Tout ce qui n'est pas capté par un filtre coché reste sur l'indicateur Affaiblissements normal. Les listes de sorts personnalisées ne peuvent plus contrôler cela sur Retail (12.1+)."
L["highlightDebuffFiltersTip"] = "Les filtres cochés se combinent et s'excluent mutuellement : une correspondance ne s'affiche que sous le premier filtre coché (de haut en bas), jamais deux fois. Rien de coché = rien affiché."
L["highlightDebuffFiltersTip_nonplayer"] = "Affiche les affaiblissements qui n'ont PAS été lancés par vous ou votre familier."
L["highlightDebuffFiltersTip_priority"] = "Affiche les affaiblissements que Blizzard marque comme importants pour les cadres de raid (isPriorityAura)."
L["highlightDebuffFiltersTip_cc"] = "Affiche les affaiblissements de contrôle de foule (étourdissement, peur, racine, etc.)."
L["highlightDebuffFiltersTip_bossaura"] = "Affiche les affaiblissements que Blizzard marque comme auras de boss (donjon/raid)."
L["highlightDebuffFiltersTip_roleaura"] = "Affiche les affaiblissements que Blizzard marque comme pertinents pour votre rôle (ex. affaiblissements de tank)."
L["highlightDebuffFiltersTip_raid"] = "Affiche les affaiblissements que Blizzard signale comme pertinents pour le raid."
L["highlightDebuffFiltersTip_raidcombat"] = "Affiche les affaiblissements pertinents pour le raid pendant que vous êtes en combat."
L["highlightDebuffFiltersTip_dispellable"] = "Affiche les affaiblissements que VOUS pouvez dissiper/purifier maintenant."
L["highlightDebuffFiltersTip_dispeltyped"] = "Affiche tout affaiblissement ayant un type de dissipation (Magie/Malédiction/Maladie/Poison/Saignement), que vous puissiez le retirer ou non."
L["Fade at Full Health"] = "Estomper à pleine vie"
L["healthFadeTip"] = "Estompe le cadre d'une unité (avec la valeur 'Alpha hors portée') dès que sa vie dépasse le seuil ci-dessous, pour que les unités en bonne santé passent à l'arrière-plan et que les blessées ressortent."
L["Health Fade Threshold"] = "Seuil d'estompage par vie"