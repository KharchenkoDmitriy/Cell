...
L["raidStyleSwitchChatMsg"] = "I riquadri di gruppo tradizionali causano noti errori di Blizzard (taint). Cell è passato automaticamente ai riquadri in stile raid per evitare ciò. È necessario un reload dell'interfaccia perché la modifica abbia effetto."
L["raidStyleSwitchPopupText"] = "I riquadri di gruppo tradizionali causano noti errori di Blizzard.\n\nCell è passato automaticamente ai riquadri in stile raid per evitare ciò.\n\nÈ necessario un reload dell'interfaccia perché la modifica abbia effetto.\n "
L["bossDebuffsTabNotice"] = "Le liste personalizzate di Debuff da Raid non funzionano più su Retail (12.1+)\n\nBlizzard nasconde molti ID incantesimo delle aure da combattimento sui riquadri di gruppo e raid, quindi gli addon non possono più filtrare in modo affidabile in base alla tua lista di attivazione/disattivazione.\n\nCosa è cambiato:\n• Il vecchio indicatore \"Debuff da Raid\" ora si chiama \"Highlight Debuffs\".\n• Mostra le aure dannose che corrispondono alle classi di filtro selezionate qui sotto (flag forniti da Blizzard, es. isBossAura).\n• Tutto il resto rimane nell'indicatore Debuff normale.\n\nLa lista incantesimi, le caselle di controllo e l'ordine in questa scheda non hanno più effetto sui riquadri Retail. Classic e MoP restano invariati."
L["nonPlayerAurasTip"] = "Nasconde gli effetti residui della Furia come Esaurimento, Saziato, Clemenza e Distorsione Temporale, oltre all'Armatura Diabolica. I debuff da incontro restano visibili."
L["debuffTooltipMouseoverTip"] = "Il passaggio del mouse su un'icona qui bloccherà le tue macro/incantesimi @mouseover in quel punto. Lascia questa casella deselezionata per evitarlo del tutto."
L["keepInHealersTip"] = "Se attivo, questo buff rimane visibile anche nell'indicatore Guaritori.|Se disattivato, appare solo qui e viene rimosso da Guaritori."
L["glowDisabledApiWarning"] = "Purtroppo il bagliore non può essere implementato al momento a causa di cambiamenti API. Ho disabilitato questo indicatore per ora, finché non si trova una soluzione."
L["crowdControlsApiWarning"] = "Cell non può più usare una lista CC personalizzata. Blizzard decide quali debuff sono controllo folla, e questo indicatore li mostra automaticamente."
L["bossDebuffsApiWarning"] = "Highlight Debuffs mostra le aure dannose che corrispondono a uno qualsiasi dei filtri selezionati sotto. Tutto ciò che non rientra in un filtro selezionato rimane nell'indicatore Debuff normale. Le liste di incantesimi personalizzate non possono più controllare questo su Retail (12.1+)."
L["highlightDebuffFiltersTip"] = "I filtri selezionati si combinano e si escludono a vicenda: una corrispondenza viene mostrata solo dal primo filtro selezionato (dall'alto verso il basso), mai due volte. Nessuno selezionato = niente mostrato."
L["highlightDebuffFiltersTip_nonplayer"] = "Mostra i debuff che NON sono stati lanciati da te o dal tuo famiglio."
L["highlightDebuffFiltersTip_priority"] = "Mostra i debuff che Blizzard contrassegna come importanti per i riquadri raid (isPriorityAura)."
L["highlightDebuffFiltersTip_cc"] = "Mostra i debuff di controllo folla (stordimento, paura, radice, ecc.)."
L["highlightDebuffFiltersTip_bossaura"] = "Mostra i debuff che Blizzard contrassegna come aure da boss (spedizione/raid)."
L["highlightDebuffFiltersTip_roleaura"] = "Mostra i debuff che Blizzard contrassegna come rilevanti per il tuo ruolo (es. debuff da tank)."
L["highlightDebuffFiltersTip_raid"] = "Mostra i debuff che Blizzard segnala come rilevanti per il raid."
L["highlightDebuffFiltersTip_raidcombat"] = "Mostra i debuff rilevanti per il raid mentre sei in combattimento."
L["highlightDebuffFiltersTip_dispellable"] = "Mostra i debuff che TU puoi dissolvere/purificare in questo momento."
L["highlightDebuffFiltersTip_dispeltyped"] = "Mostra qualsiasi debuff con un tipo di dissolvenza (Magia/Maledizione/Malattia/Veleno/Sanguinamento), indipendentemente dal fatto che tu possa rimuoverlo."
L["Fade at Full Health"] = "Dissolvi a Salute Piena"
L["healthFadeTip"] = "Attenua il riquadro di un'unità (usando il valore di 'Out of Range Alpha') quando la sua salute supera la soglia sottostante, così le unità in salute passano in secondo piano e quelle ferite risaltano."
L["Health Fade Threshold"] = "Soglia di Dissolvenza per Salute"