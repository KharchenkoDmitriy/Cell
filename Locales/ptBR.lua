...
L["raidStyleSwitchChatMsg"] = "Os quadros de grupo tradicionais causam erros conhecidos da Blizzard (taint). O Cell mudou automaticamente para quadros no estilo raide para evitar isso. É necessário recarregar a interface para que a mudança tenha efeito."
L["raidStyleSwitchPopupText"] = "Os quadros de grupo tradicionais causam erros conhecidos da Blizzard.\n\nO Cell mudou automaticamente para quadros no estilo raide para evitar isso.\n\nÉ necessário recarregar a interface para que a mudança tenha efeito.\n "
L["bossDebuffsTabNotice"] = "Listas personalizadas de Debuffs de Raide não funcionam mais no Retail (12.1+)\n\nA Blizzard esconde muitos IDs de feitiço de auras de combate nos quadros de grupo e raide, então os addons não conseguem mais filtrar de forma confiável pela sua própria lista de ativar/desativar.\n\nO que mudou:\n• O antigo indicador \"Debuffs de Raide\" agora se chama \"Highlight Debuffs\".\n• Ele mostra auras prejudiciais que correspondem às classes de filtro marcadas abaixo (flags fornecidas pela Blizzard, ex. isBossAura).\n• Tudo o mais permanece no indicador normal de Debuffs.\n\nA lista de feitiços, as caixas de seleção e a ordem desta aba não têm mais efeito nos quadros do Retail. Classic e MoP continuam inalterados."
L["nonPlayerAurasTip"] = "Oculta os efeitos residuais de Sede de Sangue, como Exaustão, Saciado, Clemência e Distorção Temporal, além da Armadura Demoníaca. Debuffs de encontro continuam visíveis."
L["debuffTooltipMouseoverTip"] = "Passar o mouse sobre um ícone aqui bloqueará suas próprias macros/feitiços @mouseover nesse local. Deixe isso desmarcado para evitar isso completamente."
L["keepInHealersTip"] = "Se ativado, este buff também permanece visível no indicador de Curandeiros.|Se desativado, ele só aparece aqui e é removido de Curandeiros."
L["glowDisabledApiWarning"] = "Infelizmente o brilho não pode ser implementado agora devido a mudanças na API. Desativei este indicador por enquanto, até que uma solução seja encontrada."
L["crowdControlsApiWarning"] = "O Cell não pode mais usar uma lista personalizada de CC. A Blizzard decide quais debuffs são controle de grupo, e este indicador os mostra automaticamente."
L["bossDebuffsApiWarning"] = "Highlight Debuffs mostra auras prejudiciais que correspondem a qualquer um dos filtros marcados abaixo. Tudo que não for capturado por um filtro marcado permanece no indicador normal de Debuffs. Listas de feitiços personalizadas não podem mais controlar isso no Retail (12.1+)."
L["highlightDebuffFiltersTip"] = "Filtros marcados se combinam e se excluem: uma correspondência aparece apenas sob o primeiro filtro marcado (de cima para baixo), nunca duas vezes. Nada marcado = nada exibido."
L["highlightDebuffFiltersTip_nonplayer"] = "Mostra debuffs que NÃO foram lançados por você ou seu bicho de estimação."
L["highlightDebuffFiltersTip_priority"] = "Mostra debuffs que a Blizzard marca como importantes para os quadros de raide (isPriorityAura)."
L["highlightDebuffFiltersTip_cc"] = "Mostra debuffs que são controle de grupo (atordoamento, medo, enraizamento, etc.)."
L["highlightDebuffFiltersTip_bossaura"] = "Mostra debuffs que a Blizzard marca como auras de chefe (masmorra/raide)."
L["highlightDebuffFiltersTip_roleaura"] = "Mostra debuffs que a Blizzard marca como relevantes para sua função (ex. debuffs de tank)."
L["highlightDebuffFiltersTip_raid"] = "Mostra debuffs que a Blizzard sinaliza como relevantes para a raide."
L["highlightDebuffFiltersTip_raidcombat"] = "Mostra debuffs relevantes para a raide enquanto você está em combate."
L["highlightDebuffFiltersTip_dispellable"] = "Mostra debuffs que VOCÊ pode dissipar/curar agora."
L["highlightDebuffFiltersTip_dispeltyped"] = "Mostra qualquer debuff com um tipo de dissipação (Magia/Maldição/Doença/Veneno/Sangramento), independentemente de você conseguir removê-lo."
L["Fade at Full Health"] = "Esmaecer com Vida Cheia"
L["healthFadeTip"] = "Esmaece o quadro de uma unidade (usando o valor de 'Opacidade de Fora de Alcance') quando sua vida sobe acima do limite abaixo, para que unidades saudáveis fiquem em segundo plano e as feridas se destaquem."
L["Health Fade Threshold"] = "Limite de Esmaecimento por Vida"