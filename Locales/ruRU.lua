...
L["Private Dispel Overlay"] = "Приватный оверлей диспелла"
L["Show private dispel overlay"] = "Показывать приватный оверлей диспелла"
L["Only dispellable by me"] = "Только рассеиваемые мной"
L["Overlay Alpha"] = "Прозрачность оверлея"
L["Overlay Frame Level"] = "Слой кадра оверлея"
L["Overlay Inset"] = "Отступ оверлея"
L["Dispels"] = "Диспеллы"
