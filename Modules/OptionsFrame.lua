...
local function CreateTabButtons()
    ...
    debuffsBtn = Cell.CreateButton(optionsFrame, Cell.isRetail and L["Raid debuffs"] or L["Raid Debuffs"], "accent-hover", {120, 20}, false, false, "CELL_FONT_WIDGET_TITLE", "CELL_FONT_WIDGET_TITLE_DISABLE")
