...
local font_title = _G[font_title_name] or CreateFont(font_title_name)
...
local font_title_disable = _G[font_title_disable_name] or CreateFont(font_title_disable_name)
...
local font = _G[font_name] or CreateFont(font_name)
...
local font_small = _G[font_small_name] or CreateFont(font_small_name)
...
local font_chinese = _G[font_chinese_name] or CreateFont(font_chinese_name)
...
local font_disable = _G[font_disable_name] or CreateFont(font_disable_name)
...
local font_special = _G[font_special_name] or CreateFont(font_special_name)
...
local font_class_title = _G[font_class_title_name] or CreateFont(font_class_title_name)
...
local font_class = _G[font_class_name] or CreateFont(font_class_name)
